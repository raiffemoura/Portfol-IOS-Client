  ...
  return (
    <>
      <div className="spotify-page-uma-coisa ">
        ...
        <div className="album">
          <img src={iconConfig.albumUmaCoisa} alt="album" />
        </div>
        <div>
          <div className="title">
            <div>
          ...
          <div className="player">
            ...
            <div className="audio-container">
              ...
              <div className="audio-buttons">
                ...
                >
                  {isPreviusMouseOver ? (
                    <Link to={'/spotify/Peregrino'} onClick={stop}>
                      <img
                        onClick={iconConfig.stop}
                        className="previus"
          ...
          <div className="about-artist-card">
            ...
            <div className="artist-description">
              {/* Descrição */}
              <span>
                O MORADA é uma banda que tem por ansioso "gritas nos telhados o
                que Deus Tem sussurrado em seus ouvidos". Com pouco mais de 10
                anos de estrada{' '}
              </span>{' '}
              <Link to="/spotify/MORADA" onClick={stop}>
