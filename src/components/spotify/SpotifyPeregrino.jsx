    ...
    <>
      <div className="spotify-page">
        ...
        <div className="header-spotify">
          <Link to={'/'} onClick={stop}>
            <img
              className="spotify-header-img"
              src={iconConfig.arrow}
              alt="arrow"
            />
          </Link>
        ...
        {/* Capa do álbum */}
        <div className="album">
          <img src={iconConfig.albumPeregrino} alt="album" />
        </div>
        <div>
          <div className="title">
            <div>
            ...
            <div>
              <img className="liked" src={iconConfig.liked} alt="liked" />
            </div>
          </div>
          <div className="player">
            ...
            <div className="audio-container">
              ...
              <div className="audio-buttons">
                ...
                >
                  {isPreviusMouseOver ? (
                    <Link to={'/spotify/uma-coisa'}>
                      <img
                        onClick={stop}
                        className="previus"
                        src={iconConfig.previusWhite}
                        alt="previusWhite"
                      />
                    </Link>
                  ) : (
                ...
                <button
                  ...
                  onMouseOut={() => setIsHidden(false)}
                >
                  {isHidden ? (
                    <img
                      className="spotify-hidden"
                      src={iconConfig.hiddenRed}
                      alt="hiddenRed"
                    />
                  ) : (
                    <img
                      className="spotify-hidden"
                      src={iconConfig.hidden}
                      alt="hidden"
                    />
                  )}
                </button>
          ...
          <div className="about-artist-card">
            ...
            <div className="artist-description">
              {/* Descrição */}
              <span>
                Sua história começa no favor de Deus. Alessandro é um
                improvável, e como ama dizer "alguém comum". Nascido dia 30 de
                Julho de 1993 em Itajubá -MG{' '}
              </span>{' '}
              <Link to="/spotify/alessandro-vilas-boas" onClick={stop}>
                <button className="see-more">...{t('seeMore')}</button>
              </Link>
            </div>
          </div>
          {/* Créditos */}
          <div className="about-artist-card">
            ...
            <div className="card-credit">
              ...
              <button
                className="follow-button"
                onClick={() => setIsFollowing2(!isFollowing2)}
              >
                {isFollowing2 ? t('following') : t('follow')}
              </button>
            </div>
          </div>
        </div>
